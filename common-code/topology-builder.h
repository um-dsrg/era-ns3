...
template <class SwitchType>
CustomDevice* TopologyBuilder<SwitchType>::GetNode (id_t id, NodeType nodeType) {
    try {
...
template <class SwitchType>
void TopologyBuilder<SwitchType>::CreateUniqueNode (id_t nodeId, NodeType nodeType) {
    if (nodeType == NodeType::Switch) {
...
template <class SwitchType>
void TopologyBuilder<SwitchType>::CreateNodes (XMLNode *rootNode) {
...
template <class SwitchType>
std::map<id_t, Ptr<NetDevice>> TopologyBuilder<SwitchType>::BuildNetworkTopology (XMLNode *rootNode) {
    /**
...
template <class SwitchType>
void TopologyBuilder<SwitchType>::InstallP2pLinks (const std::vector<Link> &links,
                                                   std::map<id_t, Ptr<NetDevice>> &transmitOnLink) {
...
template <class SwitchType>
void TopologyBuilder<SwitchType>::AssignIpToTerminals () {
